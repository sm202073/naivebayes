...
class Sketchpad {
 public:
  ...
  std::vector<std::vector<bool>> GetSketchpadPixels() const;
 ...
 private:
  ...
  /**
   * Holds the state of each pixel in the sketchpad and represents whether it's shaded or not
   */
  std::vector<std::vector<bool>> sketchpad_pixels_;
